...
PAID_SESSION_COOKIE = (
    "ci_session=%3D; "
    "XSRF-TOKEN=%3D"
)
...
THREE_STEP_CANDLE_CLAUSE = "(( {cash} ( latest volume > 500000 and latest close > 100 and latest low >= 1 candle ago low and 1 candle ago low >= 2 candles ago low and 2 candles ago low >= 3 candles ago low and latest close > latest open ) )"
